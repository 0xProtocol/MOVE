...
namespace MOVE.Server.Debug.Formular
{
    public partial class ServerForms : Form, IServiceLogger
    {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            ThreadStart processTaskThreadball = delegate { c.Send(":\\" + "lb" + "|" + Convert.ToString(Ball.Location.X) + "|" + Convert.ToString(Ball.Location.Y) + "|" + Convert.ToString(pbx_downlocal.Location.X) + "|" + Convert.ToString(punkteGegner) + "|" + Convert.ToString(punkteSpieler)); };
